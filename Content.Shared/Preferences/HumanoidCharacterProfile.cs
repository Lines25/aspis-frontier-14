...
namespace Content.Shared.Preferences
{
    ...
    {
        private static readonly Regex RestrictedNameRegex = new(@"[^\u0030-\u0039\u0041-\u005A\u0061-\u007A\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF\u0100-\u017F\u0400-\u052F\u2DE0-\u2DFF\uA640-\uA69F '\-]"); //Aspis Cyrillic names
        ...
        public void EnsureValid(ICommonSession session, IDependencyCollection collection)
        {
            ...
            {
                name = RestrictedNameRegex.Replace(name, string.Empty); //Aspis Cyrillic names
